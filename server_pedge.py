...
Usage:
    ...
    pysoc_server.py [--dbh=<dbhv>|--dbn=<dbnv>|--nodb|--tout=<toutv>]...
    pysoc_server.py [--cert=<certv>|--key=<keyv>]...
    pysoc_server.py [--https|-o]...
...
if __name__ == "__main__":
    ...
    """
    if https: manip_str.file_search_and_replace("./templates/index.html", "http", "https")
    else    : manip_str.file_search_and_replace("./templates/index.html", "https", "http")
